...
from .health_data_constants import MeasurementSource, Provider
...
class APIClientBase:
    ...
    def __init__(self, provider: Provider, config: APIClientConfig | None = None):
...
class APIClientFactory:
    ...
    @classmethod
    def create(cls, provider: Provider, config: APIClientConfig | None = None) -> APIClientBase:
